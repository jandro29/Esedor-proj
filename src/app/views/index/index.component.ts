...
export class IndexComponent implements AfterViewInit, OnInit {
  ...
  servicesItems = [
    {imgwhite:'assets/img/imgmobilindex/img-white/findproductwhite.png',        img:'assets/img/imgmobilindex/descubrimientodeproductosmobil.svg',    title: 'Descubrimiento de producto', text: 'Planifique y evalúe las características esenciales de su producto para lograr sus objetivos comerciales y eliminar posibles errores.', state: false, length: '2xl:w-auto', route: '/servicios'},
    {imgwhite:'assets/img/imgmobilindex/img-white/designproductwhite.png',      img:'assets/img/imgmobilindex/disenhodeproductosmobil.svg',           title: 'Diseño de Productos', text: 'Crea experiencias de usuario excepcionales para tus productos digitales. Resuelva problemas reales y mejore sus métricas comerciales a través de interfaces estéticas.', state: false, length: '2xl:w-[75%]', route: '/servicios'},
    {imgwhite:'assets/img/imgmobilindex/img-white/developingsoftwarewhite.png', img: 'assets/img/imgmobilindex/desarrollodesoftwaremobil.svg',        title: 'Desarrollo de software', text: 'Implemente interfaces de usuario a medida y receptivas que sean altamente interactivas y brinden a los usuarios una experiencia similar a la nativa.', state: false, length: '2xl:w-[75%]', route: '/servicios'},
    {imgwhite:'assets/img/imgmobilindex/img-white/systemsdesingwhite.png',      img: 'assets/img/imgmobilindex/sitemasdedisenhomobil.svg',            title: 'Sistemas de diseño', text: 'Democratiza el diseño y desarrollo, para una experiencia de usuario superior y una mayor eficiencia en el tiempo de creación de tus productos digitales.', state: false, length: 'xl:w-[72%]', route: '/servicios'},
    {imgwhite:'assets/img/imgmobilindex/img-white/researchwhite.png',           img: 'assets/img/imgmobilindex/investigacionyconsultariadigital.svg', title: 'Investigación y consultoría digital', text: 'Tome las decisiones correctas y realice investigación en sus usuarios. Entiende su comportamiento y decodifica sus intereses.', state: false, length: '2xl:w-auto', route: '/servicios'},
    {imgwhite:'assets/img/imgmobilindex/img-white/transformationwhite.png',     img: 'assets/img/imgmobilindex/transformacioncultural.svg',           title: 'Transformación Cultural', text: 'Implementamos tecnología de inteligencia artificial con Chat GPT para crear chatbots y asistentes de voz que brindan soluciones rápidas y eficientes a tus clientes.', state: false, length: '2xl:w-[75%]', route: '/servicios'},
  ]
