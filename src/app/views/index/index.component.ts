...
export class IndexComponent implements AfterViewInit, OnInit {
  ...
  servicesItems = [
    {imgwhite:'assets/img/imgmobilindex/img-white/transformationwhite.svg',     img: 'assets/img/imgmobilindex/transformacioncultural.svg',           title: 'Chatbot & Voicebot', text: 'Implementamos tecnología de inteligencia artificial con Chat GPT para crear chatbots y asistentes de voz que brindan soluciones rápidas y eficientes a tus clientes.', state: false, length: '2xl:w-[75%]', route: '/servicios'},
    {imgwhite:'assets/img/imgmobilindex/img-white/developingsoftwarewhite.svg', img: 'assets/img/imgmobilindex/desarrollodesoftwaremobil.svg',        title: 'Desarrollo de software', text: 'Implemente interfaces de usuario a medida y receptivas que sean altamente interactivas y brinden a los usuarios una experiencia similar a la nativa.', state: false, length: '2xl:w-[75%]', route: '/servicios'},
    ...
    {imgwhite:'assets/img/imgmobilindex/img-white/designproductwhite.svg',      img:'assets/img/imgmobilindex/disenhodeproductosmobil.svg',           title: 'Diseño UX/UI', text: 'Crea experiencias de usuario excepcionales para tus productos digitales. Resuelva problemas reales y mejore sus métricas comerciales a través de interfaces estéticas.', state: false, length: '2xl:w-[75%]', route: '/servicios'},
