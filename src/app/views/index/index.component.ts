...
export class IndexComponent implements AfterViewInit, OnInit {
  ...
  servicesItems = [
    ...
    {title: 'Desarrollo de software', text: 'Implemente interfaces de usuario a medida y receptivas que sean altamente interactivas y brinden a los usuarios una experiencia similar a la nativa.', state: false, length: '2xl:w-[75%]', route: '/servicios'},
    {title: 'Sistemas de diseño', text: 'Democratiza el diseño y desarrollo, para una experiencia de usuario superior y una mayor eficiencia en el tiempo de creación de tus productos digitales.', state: false, length: 'xl:w-[72%]', route: '/servicios'},
